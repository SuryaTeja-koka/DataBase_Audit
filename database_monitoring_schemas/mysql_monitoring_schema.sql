-- MySQL Performance Monitoring Tables Schema
-- This file contains the schema definitions for essential MySQL monitoring tables

-- Query Performance Metrics Summary Table
CREATE TABLE IF NOT EXISTS admin.mysql_qrylog_metrics_smry (
...
CREATE TABLE IF NOT EXISTS admin.mysql_tablesize_history (
    log_date DATE,
...
CREATE TABLE IF NOT EXISTS admin.mysql_tableusage (
